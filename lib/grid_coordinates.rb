module GridCoordinates
  ...
  def self.raw_to_decomposed_coordinate(raw_coordinate)
    row_index = raw_coordinate.delete('^0-9').to_i

    column_letter = raw_coordinate.delete('^a-zA-Z').capitalize
  ...
  def self.decomposed_to_raw_coordinate(decomposed_coordinate); end
end
